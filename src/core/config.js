...
export function loadEnvConfig(env = process.env) {
  return {
    ...
    feishuDeliveryProvider: env.FEISHU_DELIVERY_PROVIDER || "auto",
    feishuAnycrossWebhookUrl: env.FEISHU_ANYCROSS_WEBHOOK_URL || "",
    feishuWebhookTriggerUrl: env.FEISHU_WEBHOOK_TRIGGER_URL || "",
    feishuWebhookTriggerToken: env.FEISHU_WEBHOOK_TRIGGER_TOKEN || "",
